...
import { ApolloFastifyServerContainerModule } from '@inversifyjs/apollo-fastify';
...
describe(ApolloSubscriptionServerContainerModule, () => {
  describe('having an express http server with an ApolloServerExpressController', () => {
...
`;
  ...
  describe('having a fastify http server with an ApolloServerFastifyController', () => {
...
`;
      ...
      const containerModule: ApolloFastifyServerContainerModule =
        ApolloFastifyServerContainerModule.graphFromOptions(
          {
            getContext: async (
